...
public class ConnectFourGUI {
   ...
   private Color background = new Color(109, 0, 0);
   ...
   private JPanel createInfoPanel() {
      ...
      Font headingFont = new Font ("Silom", Font.BOLD, 20);
      Font regularFont = new Font ("Silom", Font.BOLD, 16);
   ...
   private void createMainFrame() {      
      // Create the main Frame
      mainFrame = new JFrame ("MJ VS LBJ");
   ...
   */
   public void showTieGameMessage(){
      ...
      int selection = JOptionPane.showOptionDialog(null, "Kareem is the best.", "Neither LBJ or MJ are the GOAT.", 
   ...
   */
   public void showWinnerMessage(int player){
      String[] options = {"Restart Game", "Exit"};
      int selection = JOptionPane.showOptionDialog(null, " is the best!", "The GOAT has been decided!", 
